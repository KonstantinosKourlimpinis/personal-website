...
const ScrollExpandMedia = ({
  ...
  return (
    <div
      ...
      style={expandedBgSrc ? {
        backgroundImage: `url('${expandedBgSrc}')`,
      ...
      <section className='relative flex flex-col items-center justify-start min-h-[100dvh]'>
        <div className='relative w-full flex flex-col items-center min-h-[100dvh]'>
          ...
          >
            ...
            {bgCaption && (
              <p className='absolute bottom-5 right-6 text-white/60 text-xs italic tracking-wider z-10 pointer-events-none select-none drop-shadow-md'>
                📍 {bgCaption}
              </p>
            )}
          </motion.div>
          ...
          <div className='container mx-auto flex flex-col items-center justify-start relative z-10'>
            <div className='flex flex-col items-center justify-center w-full h-[100dvh] relative'>
              ...
              >
                ...
                <div className='flex flex-col items-center text-center relative z-10 mt-4 transition-none'>
                  {date && (
                    <p
                      className='text-2xl text-white font-light tracking-widest drop-shadow-lg'
                  ...
                  {scrollToExpand && (
                    <p
                      className='text-white/90 font-semibold text-center text-sm tracking-widest uppercase mt-2 drop-shadow-lg'
                      style={{ transform: `translateX(${textTranslateX}vw)` }}
                    >
                      {scrollToExpand}
                    </p>
            ...
            <motion.section
              className='relative flex flex-col w-full px-8 py-10 md:px-16 lg:py-20'
              initial={{ opacity: 0 }}
            ...
            >
              {children}
              {expandedBgCaption && (
                <p className='absolute bottom-2 right-6 text-white/50 text-xs italic tracking-wider pointer-events-none select-none drop-shadow-md'>
                  📍 {expandedBgCaption}
                </p>
              )}
            </motion.section>
